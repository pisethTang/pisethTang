...
Decides when a battery charges vs. discharges against price signals to minimize cost, with a deployed dashboard for the results. `[one line on the method — LP / MPC / RL?]`
